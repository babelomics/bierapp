 ...
 */
public class VariantBierAppMongoQueryBuilder extends VariantMongoQueryBuilder {
    public VariantBierAppMongoQueryBuilder(MongoCredentials credentials) throws UnknownHostException {
        super(credentials);
    }
